...
export class init1648313976200 implements MigrationInterface {
    name = 'init1648313976200'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profiles" ("id" SERIAL NOT NULL, "user_id" integer, "avatar" character varying, "address" character varying, "phone" character varying, "description" character varying, "gender" character varying, "position" character varying, "birthday" TIMESTAMP, CONSTRAINT "REL_9e432b7df0d182f8d292902d1a" UNIQUE ("user_id"), CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "information" ("id" SERIAL NOT NULL, "user_id" integer, "status" boolean NOT NULL DEFAULT false, "type" character varying NOT NULL, "value" character varying(255) NOT NULL, CONSTRAINT "PK_091c910b61c3170a50eaf22e0c4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "user_conversation" ("id" SERIAL NOT NULL, "user_id" integer, "conversation_id" integer, "last_message_id" integer, CONSTRAINT "PK_3dad130078898b9325da36ab3db" PRIMARY KEY ("id"))`);
